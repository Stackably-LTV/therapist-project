...
import { sendTreatmentPlan } from '@/components/2f6bcc4feedf';
export async function POST(request, { params }) {
    try {
        ...
        const result = await sendTreatmentPlan(auth.userId, planId, {
        ...
        console.error('[api/therapist/treatment-plans/:planId/send] POST error', err);
